...
<title>Insert title here</title>
 <script src="https://cdnjs.cloudflare.com/ajax/libs/twilio/3.54.0/twilio.min.js"></script>
<script>
function myFunction() {
  var txt;
...
<body>
<form action="OTPs.java" method="get" >
  <div class="card">
        <div class="form">
          <h3>Login</h3>
         ...
         <input type="submit" value="Login" name="name" onclick="myFunction()" style="height: 45px; background-color: #7227D5;border:none;color:white;border-radius: 5px;font-size: 18px; ">
 </a>
        </div>
