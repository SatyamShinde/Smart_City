...
@media ( max-width : 768px) {
	...
	ul.radio-buttons-w3-agileits2 li {
		margin: 0em 1em;
	}
}
...
<body>
	...
	<div class="booking-form-w3layouts">
		<!-- Form starts here -->
		<form action="busbookingservlet" method="post">
			<h2 class="sub-heading-agileits">Bus Reservation</h2>
        ...
        <div class="field-agileinfo-spc form-w3-agile-text2">
           <select class="form-control">
			...
			<div class="main-flex-w3ls-sectns">
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" name="address1" placeholder="From, Address"
						required="">
				</div>
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" name="address2" placeholder="To, Address"
						required="">
				</div>
			</div>
			...
			<div class="main-flex-w3ls-sectns">
				...
				<div class="field-agileinfo-spc form-w3-agile-text1">
					<input type="text" name="landmark2" placeholder="Landmark"
						required="">
				</div>
			</div>
			<!-- <div class="main-flex-w3ls-sectns">
           ...
           <input type="text" id="timepicker" name="Time" class="timepicker form-control hasWickedpicker" placeholder="Departure Time" value="" onkeypress="return false;">
			...
			<div class="triple-wthree">
				<div class="field-agileinfo-spc form-w3-agile-text11">
					<select class="form-control" style="margin-top: px;" name="adult">
				...
				<div class="field-agileinfo-spc form-w3-agile-text33">
					<select class="form-control" name="buses">
						<option >Buses</option>
						<option >Sindh Travles</option>
						<option >Samarth Travles</option>
						<option >Royal Travles</option>
						<option >Purple Travles</option>
						<option >Swarali Travles</option>
					</select>
				</div>
			</div>
			<div class="radio-section">
				<h6>Select your Fare</h6>
						...
						<label for="a-option" name="fare"><input type="radio" id="a-option" name="selector1" value="Oneway">One-Way</label>
					
					<label for="b-option" name="fare" ><input type="radio" id="b-option" name="selector1" value="Roundway">Round-Way</label>
			...
			<p
					style="color: #0091cd; margin-top: 10px; color: #0091cd; font-size: 19px; text-transform: capitalize; margin-bottom: 0.7em; font-weight: 400; letter-spacing: 2px; font-family: 'Raleway', sans-serif;">Preferred
					Bus</p>

				
				<label for="aa-option" name="bus" ><input type="radio" id="aa-option" name="selector10" value="AC" style="margin-top: 20px;">AC</label>
						

					<label for="bb-option" name="bus" ><input type="radio" id="bb-option" name="selector10" value="Non-AC">Non-Ac</label>
			...
			<div class="container" style="display: flex;">
			  	...
			  	<p style="color: #0091cd; margin-top: 10px; color: #0091cd; font-size: 19px; text-transform: capitalize; margin-bottom: 0.7em; font-weight: 400; letter-spacing: 2px; font-family: 'Raleway', sans-serif;">Select
					Berth</p>

				        <label for="ccc-option" name="berth"><input type="radio" id="ccc-option" name="selector100" value="Single-Upper" style="margin-top: 20px;"> Single Upper</label>
					
						<label for="dd-option" name="berth" ><input type="radio" id="dd-option" name="selector100" value="Single-Lower" >Single Lower</label>
						
						<label for="ee-option" name="berth" ><input type="radio" id="ee-option" name="selector100" value="Double-Upper" style="margin-top: 20px;">Double Upper  </label>
					
						<label for="ff-option" name="berth" ><input type="radio" id="ff-option" name="selector100" value="Double-Lower" > Double Lower </label>
					
			</div>


			<!-- <div class="radio-section2">
        <h6>Select your Fare</h6>
        <ul class="r2">
           <li>
